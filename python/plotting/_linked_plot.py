    ...
    def add_plot(self, numpy_array, data_column_name, plot_title):
        ...
        args:
           numpy_array(np.array):
              It is assumed that numpy_array['date'] exists.
              numpy_array['date'] must be either dtype:('date', 'f8') as an
              epoch timestamp as generated by datetime.datetime.timestamp(),
              or it may be a datetime.date object stored in the numpy array with
              dtype:('date', 'O')
           data_column_name(str): The name of the data column to plot on the x axis.
           plot_title(str):           
        """
